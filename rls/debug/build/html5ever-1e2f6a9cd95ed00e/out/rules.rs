use tree_builder :: types :: * ; use tree_builder :: tag_sets :: * ; use tokenizer :: states :: {
Rcdata , Rawtext , ScriptData , Plaintext
} ; use std :: borrow :: ToOwned ; use tendril :: SliceExt ; fn any_not_whitespace ( x : & StrTendril ) -> bool {
